<nav class="nav has-shadow">
    <div class="container">
        <div class="nav-left">
            ...
            <a class="nav-item is-tab is-hidden-mobile @if(substr(request()->fullUrl(), strpos(request()->getUri(), "/", 7)) == '/properties') is-active @endif" href="/forms">Forms</a>
            <a class="nav-item is-tab is-hidden-mobile @if(substr(request()->fullUrl(), strpos(request()->getUri(), "/", 7)) == '/properties') is-active @endif" href="/contact">Contact</a>
        </div>
